...
REMEDIATION = {
    ...
    "steps": [
        ...
        {
            "text": "Verify no legacy LDAP clients (e.g. old Linux/Unix hosts, network devices, applications) rely on unsigned LDAP before enforcing. Use event ID <strong>2886</strong> and <strong>2887</strong> in the Directory Service event log to identify non-compliant clients.",
        },
    ],
}
