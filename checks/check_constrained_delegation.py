...
_HIGH_VALUE_SERVICES = {
      "cifs", "ldap", "ldaps", "host", "http", "mssql", "MSSQLSvc", "wsman", "rpcss",
}

# Extended set used for DC-targeting analysis (includes DC-specific service classes)
_DC_HIGH_VALUE_SERVICES = {
      "ldap", "cifs", "host", "gc", "krbtgt", "rpc", "rpcss",
      "http", "wsman", "termsrv", "dns", "time", "w32time",
}
...
def run_check(connector, verbose=False):
    ...
    high_value_sams = set()   # sAMAccountNames already in high_value_accounts (for dedup)
    ...
    # ----------------------------------------------------------------
    # Informational: any KCD not already flagged above
    # ----------------------------------------------------------------
